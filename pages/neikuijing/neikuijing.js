...
Page({
  ...
  onChange(e) {
    ...
    console.log(current);
    wx.request({
      url: app.globalData.localApiUrl + 'histool/queue/list?office=内窥镜室&room=' + current + '&ca=1',
      method: 'GET',
      success(res) {
  ...
  onShow: function() {
    ...
    wx.request({
      url: app.globalData.localApiUrl + 'histool/queue/list?office=内窥镜室&room=' + that.data.currentTab + '&ca=1', //+ that.data.currentTab,
      method: 'GET',
      success(res) {
        console.log(res.data);
        wx.hideNavigationBarLoading() //完成停止加载
